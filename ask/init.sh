...
mysql -uroot -e "insert into Flow.auth_user (password,last_login,is_superuser,username,first_name,last_name,email,is_staff,is_active,date_joined) values ('SayHi_k20',sysdate(),1,'test_user','Тест','Тестов','test@mail.ru',1,1,sysdate());"
